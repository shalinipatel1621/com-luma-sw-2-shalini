...
public class LoginTest extends BaseTest {
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials() {
        ...
        driver.findElement(By.id("email")).sendKeys("jackdoe@gmail.com");
        // Find and enter password
        driver.findElement(By.name("login[password]")).sendKeys("jackdoe@123");
        // Find and click on the sign in button
        driver.findElement(By.name("send")).click();
        // Verify the welcome text
        String expectedWelcomeText = "Welcome, Jack Doe!";
        String actualWelcomeText = driver.findElement(By.xpath("//div[@class='panel header']//span[@class='logged-in'][normalize-space()='Welcome, Jack Doe!']")).getText();
    ...
    public void verifyTheErrorMessageWithInvalidCredentials() {
        ...
        driver.findElement(By.id("email")).sendKeys("jackdoe@gmail.com");
        // Find and enter password
        driver.findElement(By.name("login[password]")).sendKeys("jackdoe123");
        // Find and click on the sign in button
        driver.findElement(By.name("send")).click();
